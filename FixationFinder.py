...
def find_fixations_for_participants(participants):
...
def find_fixations_for_single_participant(participant_name):
    ...
    with open(join(PATH_DATA_PREPROCESSED, "fixations", participant_name + ".pkl"), 'wb') as output:
...
if __name__ == "__main__": find_fixations_for_participants(PARTICIPANTS)
